...
public class FragmentExCatLivros extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex_cat_livros, container, false);
        ...
        btnExcluir = (Button) v.findViewById(R.id.btnAlterarCatLivros);
    ...
    public void exCatLivros(View v) {
        ...
        crud.deletaCategoriaLivros(Integer.parseInt(codigo));
